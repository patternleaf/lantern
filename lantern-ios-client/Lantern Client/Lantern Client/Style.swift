...
class Style {
	...
	*/
	struct Font {
		...
		static let nothingToShowLabel = UIFont(name: "HelveticaNeue-Thin", size: 80)
		static let channelStripName = UIFont(name: "HelveticaNeue-Bold", size: 20)
	}
	
	struct Dim {
		
		static let parameterViewPadding: CGFloat = 20
		static let parameterViewSpacing: CGFloat = 12
	}
